...
if (isset($_POST['submit'])) {
    ...
    $InsertQuery = mysql_query("insert into admission(AdmissionInstituteName,ProgramEvalute,FrequencyAdmission,NewStdAdmission,NewInstruments,AdmissionRqm,IsOpenMerit,HowMerit,StdPerAdmission) values('$name','$evaluate','$frequency','$admitted','$instrument','$admission','$merit','$compiled','$process')") or die(mysql_error());
            ...
            <div class="panel-body">
                ...
                <form method="post" class="text-left">
                    <strong>NAME OF INSTITUTION:
                        <sup></sup>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>
                    <input type="text" name="nameofinstitute" value="" size="105">
                    ...
                    <strong>BE EVALUATED&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <sup></sup>&nbsp;</strong>
                    <input type="text" name="programstobeevaluated" value="" size="105">
                    <table width="497">
                        <tbody>
                        <tr>
                            <td></td>
                    ...
                    <ul>
                        <li>
                            <strong>Frequency of admission per academic year. Give detail.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <sup></sup>&nbsp;</strong>
                            <br>
                            <textarea name="frequency" rows="6" cols="163"></textarea>
                        </li>
                    </ul>
                    <p>&nbsp;</p>
                    <ul>
                        <li>
                            ...
                            <br>
                            <textarea name="studentsadmittedinprogram" rows="6" cols="163"></textarea>
                        </li>
                    </ul>
                    <table>
                        <tbody>
                    ...
                    <ul>
                        <li>
                            ...
                            <br>
                            <textarea name="instruments" rows="6" cols="163"></textarea>
                        </li>
                    </ul>
                    <table>
                        <tbody>
                    ...
                    <ul>
                        <li>
                            ...
                            <br>
                            <textarea name="requirementforadmission" rows="6" cols="163"></textarea>
                        </li>
                    </ul>
                    <table>
                        <tbody>
                    ...
                    <ul>
                        <li>
                            ...
                            <br>
                            <textarea name="merit" rows="6" cols="163"></textarea>
                        </li>
                    </ul>
                    <p>
                        <em>&nbsp;</em>
                    ...
                    <ul>
                        <li>
                            ...
                            <br>
                            <textarea name="meritcomplied" rows="6" cols="163"></textarea>
                        </li>
                    </ul>
                    <p>
                        <em>&nbsp;</em>
                    ...
                    <ul>
                        <li>
                            ...
                            <br>
                            <textarea name="studentsinductedperadmission" rows="6" cols="163"></textarea>
                        </li>
                    </ul>
                    <p>
                        <em>&nbsp;</em>
                    ...
                    <ul>
                        <li>
                            ...
                            <br>
                            <textarea name="transparencyadmissionprocess" rows="6" cols="163"></textarea>
                        </li>
                    </ul>
                    <table>
                        <tbody>
                    ...
                    <div class="container text-center">
                        ...
                        <button type="button" name="submit" class="btn btn-primary btn-md">Submit</button>
                        <div class="btn-group btn-group-md">
